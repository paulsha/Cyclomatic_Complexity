...
stack exec complexity-api worker localhost 8004 &
stack exec complexity-api worker localhost 8005 &
stack exec complexity-api worker localhost 8006 &
stack exec complexity-api worker localhost 8007 